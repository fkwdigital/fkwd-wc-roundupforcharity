...
?>
<div class="<?php echo $this->clean_string(FKWD_PLUGIN_WCRFC_NAMESPACE . '-settings-' .  $page_id . '-form', ['type' => 'attribute']); ?> wrap">
	<h1><?php echo $this->clean_string( $page_options['page_title'] ); ?></h1>

	<?php settings_errors( FKWD_PLUGIN_WCRFC_NAMESPACE . '-messages' ); ?>

	<form action="<?php echo $this->clean_string(admin_url('options.php'), ['type' => 'url']); ?>" method="post" onkeydown="return event.key != 'Enter';">
		<?php
    ...
    <div class="<?php echo $this->clean_string(FKWD_PLUGIN_WCRFC_NAMESPACE . '-generate-report-form', ['type' => 'attribute']); ?>">
        ...
        <table class="<?php echo $this->clean_string(FKWD_PLUGIN_WCRFC_NAMESPACE . '-report-results-table', ['type' => 'attribute']); ?>" cellspacing="0">
            <thead>
                <tr>
                    <th>Total Orders</th>
